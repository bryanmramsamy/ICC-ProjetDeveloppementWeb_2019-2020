...
if (checkPermissions('modo', false)){    
    ...
    if ($article['availability']) echo("<a class=\"btn btn-info\" href='" . $make_available_link . "'>Rendre l'article indisponible</a>");
    else if (checkPermissions('admin', false)) echo ("<a class=\"btn btn-info\" href='" . $make_available_link . "'>Rendre l'article disponible</a>");
